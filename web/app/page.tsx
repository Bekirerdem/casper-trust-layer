...
import { LiveGrid } from "@/components/atmosphere/LiveGrid";

export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-bg pt-24">
      {/* Atmosphere: one grid that answers the pointer, one glow behind the hero.
          Anything more competes with the live card, which is the only thing that
          should pull the eye. */}
      <LiveGrid />

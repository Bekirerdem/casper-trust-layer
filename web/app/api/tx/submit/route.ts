...
// Generic wallet-signed transaction submitter: re-attaches the browser-wallet
// signature to a server-built Transaction and submits it via cspr.cloud
// (token stays server-side). Same mechanics as /api/register/submit.

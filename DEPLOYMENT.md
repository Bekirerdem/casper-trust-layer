...
The Casper ecosystem at the time of writing required three workarounds for an
...
The contract code itself is unmodified and fully tested (31 green OdraVM tests).
